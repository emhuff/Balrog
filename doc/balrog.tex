...
If no WCS exists in the header, the pipeline enforces a fiducial WCS with a constant pixel scale of 0.263~arcsec/pixel.
...
It calls the \texttt{Sersic} class to define the galaxies' light distriubtions as \sersic{} profiles. 
By effectively adding together \texttt{Sersic} objects, \balrog{} allows galaxies to be composed of as many superimposed
...
two centroid coordinate positions $(x, y)$, two components of lesning reduced shear $(g_1, g_2)$, and magnfication.
...
To be explictly clear, the shear and magnification are lensing effects applied a galaxy,
and the axis ratio mentioned is the intrinsic axis ratio for the galaxy.
