...
\usepackage{title,optstable,config,outtable,todonotes,journals}
...
\notesuchyta{We should decide what the best name for everything is, bot the full name and abbreviation.}
