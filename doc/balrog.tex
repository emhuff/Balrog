...
\textbf{\balrog{}} & & \textbf{\sex{}} \\ \midrule \midrule \\
...
\opt{sexparam} & $\rightarrow$  &\codett{PARAMETERS\_NAME} \\ \bottomrule
\end{tabular}
\end{table}
...
\rules{beta} & Orientaiton angle of major axis (measured from $x$-axis) [degrees] \\ \bottomrule
\end{tabular}
\end{table}
