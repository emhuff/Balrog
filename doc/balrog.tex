...
\noindent and check the output directories in \texttt{default\_example/output}.  Check \texttt{config.py} for how to 
do simulations.
...
trading clarity for brevity. Use the \opt{help} flag
if interested in the abbreviations.
